...
public class AppTest 
{
    ...
    @Before
    public void setup() {
        _file1 = new String[]{"src/main/resources/monster.dot", "4", "-o", "monster1", "-p", "4"};
        _file2 = new String[]{"src/main/resources/e2.dot", "4", "-o", "me2", "-p", "4"};
        _file3 = new String[]{"src/main/resources/e3.dot", "4", "-o", "me3", "-p", "4"};
        _file4 = new String[]{"src/main/resources/e4.dot", "4", "-o", "me4", "-p", "4"};
        _file5 = new String[]{"src/main/resources/e5.dot", "4", "-o", "me5", "-p", "4"};
